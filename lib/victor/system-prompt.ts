...
export function buildUserContextBlock(params: {
  ...
  if (esSaludoDiario) {
    lines.push(
      ...
      "     hecho cerrado.",
      "  3. NUNCA digas 'ya categoricé X' sin haber confirmado que la",
      ...
      "  4. Si quedó algo pendiente de verdad (ambiguo, no reconocido, o",
      "     fallido según el punto 3), dilo en el mismo mensaje de saludo —",
      "     con el nombre del comercio y el monto, no solo 'tienes gastos",
      "     pendientes'. Ejemplo de espíritu: 'Buenos días, Joel — anoche",
      "     entraron 4 transacciones nuevas, ya categoricé 3, pero la de Home",
      "     Depot por $85 no supe si fue personal o de negocio, ¿me ayudas?'",
      "  5. Si no hay NADA pendiente (revisar_gastos_sin_categorizar no",
      "     encontró nada, o no hay banco conectado todavía), no inventes",
      "     trabajo — un saludo breve y cálido basta, sin forzar una alerta",
      "     que no existe.",
      "  6. Nunca menciones la palabra 'sincronización', 'cron', 'Plaid', ni",
