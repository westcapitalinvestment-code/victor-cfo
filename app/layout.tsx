...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es">
      ...
      <body>
        {/* Meta Pixel (16 sept 2026) — instalado a nivel de layout raíz para
            que dispare PageView en TODA la app (landing, /registro, etc.),
            como recomienda Meta. strategy="afterInteractive": no bloquea el
